...
export const CONTENT = {
    ...
    history: {
        ...
        image: '/src/assets/history/fundadores_v2.jpg',
        paragraphs: [
    ...
    nominata: {
        ...
        members: [
            { role: 'Venerável Mestre', name: 'EDUARDO CÉSAR OLIVEIRA SOUZA', photo: '/src/assets/nominata/eduardo_souza.png' },
            { role: '1º Vigilante', name: 'HAILDO JARBAS RODRIGUES', photo: '/src/assets/nominata/haildo_rodrigues.png' },
            { role: '2º Vigilante', name: 'SÁVIO JOSÉ FERNANDES DA SILVA', photo: '/src/assets/nominata/savio_silva.png' },
            { role: 'Orador', name: 'RAFAEL NORMANDO MIRANDA', photo: '/src/assets/nominata/rafael_miranda.png' },
            { role: 'Orador Adjunto', name: 'ASDRÚBAL FRANCISCO EPAMINONDAS DE MELO', photo: '/src/assets/nominata/asdrubal_melo.png' },
            { role: 'Secretário', name: 'EDUARDO SIMÕES PASSOS', photo: '/src/assets/nominata/eduardo_passo.png' },
            { role: 'Secretário Adjunto', name: 'FRANCISCO MOACIR MAIA FILHO', photo: '/src/assets/nominata/moacir_maia.png' },
            { role: 'Chanceler', name: 'FERNANDO HUBER PICANÇO DE OLIVEIRA', photo: '/src/assets/nominata/fernando_huber.png' },
            { role: 'Tesoureiro', name: 'SOLON BANDEIRA GUEDES NETO', photo: '/src/assets/nominata/solon_bandeira.png' },
            { role: 'Tesoureiro Adjunto', name: 'NAUDIR ARAÚJO SOARES', photo: '/src/assets/nominata/naudir_soares.png' },
            { role: 'Hospitaleiro', name: 'DEUBSON RODRIGUES DE ALBUQUERQUE', photo: '/src/assets/nominata/deubson_albuquerque.png' },
            { role: 'Mestre de Cerimônias', name: 'HENRIQUE MATHEUS JOSE PEREIRA SANTOS', photo: '/src/assets/nominata/henrique_santos.png' },
            { role: '1º Diácono', name: 'FABIANO KLEBER LAGO PINTO', photo: '/src/assets/nominata/fabiano_kleber.png' },
            { role: '2º Diácono', name: 'ALISSON MOACIR DE ARAUJO MAIA', photo: '/src/assets/nominata/alisson_maia.png' },
            { role: '1º Experto', name: 'JOSÉ ESTEVAM PORTELA', photo: '/src/assets/nominata/jose_estevam.png' },
            { role: '2º Experto', name: 'ANDRE DOS SANTOS EVANGELISTA', photo: '/src/assets/nominata/andre_evangelista.png' },
            { role: 'Porta Estandarte', name: 'HELADIO DE SOUZA GOMES', photo: '/src/assets/nominata/heladio_gomes.png' },
            { role: 'Porta Espada', name: 'LAUDIMIRO OSMIDIO LIMA', photo: '/src/assets/nominata/laudimiro_lima.png' },
            { role: 'Guarda do Templo', name: 'JERRI ADRIANI PENA DE ABREU', photo: '/src/assets/nominata/jerri_abreu.png' },
            { role: 'Mestre de Banquetes', name: 'ORCIVALDO DE MORAES CABRAL', photo: '/src/assets/nominata/orcivaldo_cabral.png' },
            { role: 'Mestre de Harmonia', name: 'MANACIR PORTO DOS SANTOS FILHO', photo: '/src/assets/nominata/manacir_santos.png' },
            { role: 'Representante Titular ALM', name: 'CLAUDIO ANTÔNIO PAULA DE CASTRO', photo: '/src/assets/nominata/claudio_castro.png' },
    ...
    clubeAcacias: {
        ...
        image: '/src/assets/clube-acacias/clube_acacias_foto_grupo.jpg',
